...
CREATE TABLE [testDetail] (
	 ...
	 [main] UNIQUEIDENTIFIER  NOT NULL,
...
CREATE TABLE [ApplicationLog] (
 ...
 ALTER TABLE [testMain] ADD CONSTRAINT [testMain_FtestMaster_0] FOREIGN KEY ([master]) REFERENCES [testMaster]
CREATE INDEX testMain_Imaster on [testMain] ([master])

 ALTER TABLE [testDetail] ADD CONSTRAINT [testDetail_FtestMain_0] FOREIGN KEY ([main]) REFERENCES [testMain]
CREATE INDEX testDetail_Imain on [testDetail] ([main])
